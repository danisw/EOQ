 ...
 * Page class
 */
class PemesananView extends Pemesanan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PemesananView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_pesanan") ?? Route("id_pesanan")) !== null) {
            $this->RecKey["id_pesanan"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_pesanan") ?? Route("id_pesanan")) !== null) {
                ...
                $returnUrl = "pemesananlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "pemesananlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "pemesananlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
