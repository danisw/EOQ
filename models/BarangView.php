 ...
 * Page class
 */
class BarangView extends Barang
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_barang") ?? Route("id_barang")) !== null) {
                ...
                $returnUrl = "baranglist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "baranglist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "baranglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
