...
class Pegawai extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_pegawai
        $this->id_pegawai = new DbField('pegawai', 'pegawai', 'x_id_pegawai', 'id_pegawai', '`id_pegawai`', '`id_pegawai`', 3, 16, -1, false, '`id_pegawai`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->id_pegawai->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_pegawai->Param, "CustomMsg");
        $this->Fields['id_pegawai'] = &$this->id_pegawai;

        // username
        $this->_username = new DbField('pegawai', 'pegawai', 'x__username', 'username', '`username`', '`username`', 200, 32, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // password
        $this->_password = new DbField('pegawai', 'pegawai', 'x__password', 'password', '`password`', '`password`', 200, 16, -1, false, '`password`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_pegawai
        $this->nama_pegawai = new DbField('pegawai', 'pegawai', 'x_nama_pegawai', 'nama_pegawai', '`nama_pegawai`', '`nama_pegawai`', 200, 32, -1, false, '`nama_pegawai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamat_pegawai
        $this->alamat_pegawai = new DbField('pegawai', 'pegawai', 'x_alamat_pegawai', 'alamat_pegawai', '`alamat_pegawai`', '`alamat_pegawai`', 200, 64, -1, false, '`alamat_pegawai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamat_pegawai->Nullable = false; // NOT NULL field
        $this->alamat_pegawai->Required = true; // Required field
        $this->alamat_pegawai->Sortable = true; // Allow sort
        $this->alamat_pegawai->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alamat_pegawai->Param, "CustomMsg");
        $this->Fields['alamat_pegawai'] = &$this->alamat_pegawai;

        // hp_pegawai
        $this->hp_pegawai = new DbField('pegawai', 'pegawai', 'x_hp_pegawai', 'hp_pegawai', '`hp_pegawai`', '`hp_pegawai`', 200, 16, -1, false, '`hp_pegawai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->hp_pegawai->Nullable = false; // NOT NULL field
        $this->hp_pegawai->Required = true; // Required field
        $this->hp_pegawai->Sortable = true; // Allow sort
        $this->hp_pegawai->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->hp_pegawai->Param, "CustomMsg");
        $this->Fields['hp_pegawai'] = &$this->hp_pegawai;

        // id_bagian
        $this->id_bagian = new DbField('pegawai', 'pegawai', 'x_id_bagian', 'id_bagian', '`id_bagian`', '`id_bagian`', 3, 8, -1, false, '`id_bagian`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->id_bagian->Nullable = false; // NOT NULL field
        $this->id_bagian->Required = true; // Required field
        $this->id_bagian->Sortable = true; // Allow sort
        $this->id_bagian->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->id_bagian->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->id_bagian->Lookup = new Lookup('id_bagian', 'pegawai', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->id_bagian->OptionCount = 7;
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id_pegawai->setDbValue($conn->lastInsertId());
    ...
    {
        $keys = [];
        $val = $current ? $this->id_pegawai->CurrentValue : $this->id_pegawai->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_pegawai->CurrentValue = $keys[0];
            } else {
                $this->id_pegawai->OldValue = $keys[0];
            }
        }
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->id_pegawai->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_pegawai->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("id_pegawai") ?? Route("id_pegawai")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function renderListRow()
    {
        ...
        if ($Security->canAdmin()) { // System admin
            if (strval($this->id_bagian->CurrentValue) != "") {
                $this->id_bagian->ViewValue = $this->id_bagian->optionCaption($this->id_bagian->CurrentValue);
            } else {
                $this->id_bagian->ViewValue = null;
            }
        } else {
            $this->id_bagian->ViewValue = $Language->phrase("PasswordMask");
        }
    ...
    public function renderEditRow()
    {
        ...
        if (!$Security->canAdmin()) { // System admin
            $this->id_bagian->EditValue = $Language->phrase("PasswordMask");
        } else {
            $this->id_bagian->EditValue = $this->id_bagian->options(true);
            $this->id_bagian->PlaceHolder = RemoveHtml($this->id_bagian->caption());
        }
