 ...
 * Page class
 */
class PemesananDelete extends Pemesanan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PemesananDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pemesananlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pemesananlist"); // Return to list
                return;
            }
        }
