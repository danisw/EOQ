...
class StokAdd extends Stok
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "stokview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->curret_qty->CurrentValue = null;
        $this->curret_qty->OldValue = $this->curret_qty->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['curret_qty'] = $this->curret_qty->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // curret_qty
        $this->curret_qty->setDbValueDef($rsnew, $this->curret_qty->CurrentValue, 0, false);

        // last_update
        $this->last_update->setDbValueDef($rsnew, UnFormatDateTime($this->last_update->CurrentValue, 0), CurrentDate(), false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['id_barang']) == "") {
