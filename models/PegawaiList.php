...
class PegawaiList extends Pegawai
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->nama_pegawai->AdvancedSearch->toJson(), ","); // Field nama_pegawai
        $filterList = Concat($filterList, $this->alamat_pegawai->AdvancedSearch->toJson(), ","); // Field alamat_pegawai
        $filterList = Concat($filterList, $this->hp_pegawai->AdvancedSearch->toJson(), ","); // Field hp_pegawai
    ...
    protected function restoreFilterList()
    {
        ...
        $this->alamat_pegawai->AdvancedSearch->SearchValue = @$filter["x_alamat_pegawai"];
        $this->alamat_pegawai->AdvancedSearch->SearchOperator = @$filter["z_alamat_pegawai"];
        $this->alamat_pegawai->AdvancedSearch->SearchCondition = @$filter["v_alamat_pegawai"];
        $this->alamat_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_alamat_pegawai"];
        $this->alamat_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_alamat_pegawai"];
        $this->alamat_pegawai->AdvancedSearch->save();

        // Field hp_pegawai
        $this->hp_pegawai->AdvancedSearch->SearchValue = @$filter["x_hp_pegawai"];
        $this->hp_pegawai->AdvancedSearch->SearchOperator = @$filter["z_hp_pegawai"];
        $this->hp_pegawai->AdvancedSearch->SearchCondition = @$filter["v_hp_pegawai"];
        $this->hp_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_hp_pegawai"];
        $this->hp_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_hp_pegawai"];
        $this->hp_pegawai->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->nama_pegawai, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->alamat_pegawai, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->hp_pegawai, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->alamat_pegawai); // alamat_pegawai
            $this->updateSort($this->hp_pegawai); // hp_pegawai
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->alamat_pegawai->setSort("");
                $this->hp_pegawai->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_pegawai->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
