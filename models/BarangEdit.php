...
class BarangEdit extends Barang
{
    ...
    protected function editRow()
    {
        ...
        if ($this->nama_barang->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`nama_barang` = '" . AdjustSql($this->nama_barang->CurrentValue, $this->Dbid) . "')";
        ...
        if (!$rsold) {
            ...
            // harga_barang
            $this->harga_barang->setDbValueDef($rsnew, $this->harga_barang->CurrentValue, "", $this->harga_barang->ReadOnly);

            // biaya_penyimpanan
            $this->biaya_penyimpanan->setDbValueDef($rsnew, $this->biaya_penyimpanan->CurrentValue, "", $this->biaya_penyimpanan->ReadOnly);

            // periode_permintaan
            $this->periode_permintaan->setDbValueDef($rsnew, $this->periode_permintaan->CurrentValue, "", $this->periode_permintaan->ReadOnly);

            // satuan
            $this->satuan->setDbValueDef($rsnew, $this->satuan->CurrentValue, "", $this->satuan->ReadOnly);

            // konversi
            $this->konversi->setDbValueDef($rsnew, $this->konversi->CurrentValue, "", $this->konversi->ReadOnly);
