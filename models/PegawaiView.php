 ...
 * Page class
 */
class PegawaiView extends Pegawai
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegawaiView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_pegawai") ?? Route("id_pegawai")) !== null) {
            $this->RecKey["id_pegawai"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_pegawai") ?? Route("id_pegawai")) !== null) {
                ...
                $this->RecKey["id_pegawai"] = $this->id_pegawai->QueryStringValue;
            } elseif (Post("id_pegawai") !== null) {
                $this->id_pegawai->setFormValue(Post("id_pegawai"));
                $this->RecKey["id_pegawai"] = $this->id_pegawai->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_pegawai->setQueryStringValue($keyValue);
                $this->RecKey["id_pegawai"] = $this->id_pegawai->QueryStringValue;
            } else {
                $returnUrl = "pegawailist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "pegawailist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "pegawailist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
