 ...
 * Page class
 */
class PegawaiAdd extends Pegawai
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pegawaiview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nama_pegawai
        $this->nama_pegawai->setDbValueDef($rsnew, $this->nama_pegawai->CurrentValue, "", false);

        // alamat_pegawai
        $this->alamat_pegawai->setDbValueDef($rsnew, $this->alamat_pegawai->CurrentValue, "", false);

        // hp_pegawai
        $this->hp_pegawai->setDbValueDef($rsnew, $this->hp_pegawai->CurrentValue, "", false);

        // id_bagian
        if ($Security->canAdmin()) { // System admin
            $this->id_bagian->setDbValueDef($rsnew, $this->id_bagian->CurrentValue, 0, false);
        }
