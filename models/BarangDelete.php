 ...
 * Page class
 */
class BarangDelete extends Barang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BarangDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("baranglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("baranglist"); // Return to list
                return;
            }
        }
