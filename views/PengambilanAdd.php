...
loadjs.ready("head", function () {
    ...
    fpengambilanadd = currentForm = new ew.Form("fpengambilanadd", "add");
    ...
    // Validate form
    fpengambilanadd.validate = function () {
    ...
    // Form_CustomValidate
    fpengambilanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpengambilanadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpengambilanadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpengambilanadd" id="fpengambilanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpengambilanadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpengambilanadd", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
