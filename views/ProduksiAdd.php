...
loadjs.ready("head", function () {
    ...
    fproduksiadd.lists.id_barang = <?= $Page->id_barang->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fproduksiadd"], function() {
    fproduksiadd.createAutoSuggest(Object.assign({"id":"x_id_barang","forceSelect":false}, ew.vars.tables.produksi.fields.id_barang.autoSuggestOptions));
});
</script>
...
loadjs.ready(["fproduksiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fproduksiadd", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
